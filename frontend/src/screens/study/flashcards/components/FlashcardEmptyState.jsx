...
const FlashcardEmptyState = ({ onBack }) => {
  const { t } = useLang();
  ...
  return (
    <div className="flex flex-1 w-full max-w-sm mx-auto flex-col items-center justify-center text-center px-8 pb-16">
      ...
      <h3 className="mt-5 text-xl font-medium text-slate-700 dark:text-slate-100">{t('ext_2086')}</h3>
      <p className="mt-2 text-base leading-relaxed text-slate-400 break-keep">
        {t('ext_2786')}
      </p>
