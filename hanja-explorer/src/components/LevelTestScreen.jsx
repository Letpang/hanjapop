                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-6 px-6 overflow-y-auto pt-8">
                    <div className="clay-panel rounded-[3.5rem] p-6 sm:p-8 bg-white dark:bg-slate-800 border-4 border-white flex flex-col items-center gap-6 text-center max-w-md w-full shadow-2xl">
                        ...
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <h2 className="text-h2-res font-medium text-slate-700 dark:text-white premium-text-shadow">레벨 테스트</h2>
                            <p className="text-sm font-normal text-[#AEB7C5]">학습한 내용을 확인하고 다음 단계로!</p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 w-full">
                            <div className="bg-[#7C83FF]/10/50 dark:bg-[#4A51D4]/30 rounded-3xl p-5 flex flex-col items-center justify-center border-2 border-[#C3C6FF]/50 dark:border-[#4A51D4]">
                                ...
                                <span className="text-xs text-[#7C83FF] font-normal uppercase tracking-widest mb-1">문제 수</span>
                                <span className="text-body-lg-res font-normal text-[#4A51D4] dark:text-[#7C83FF]">{questions.length}문항</span>
                            </div>
                            <div className="bg-[#FFB433]/10/50 dark:bg-[#FFB433]/30 rounded-3xl p-5 flex flex-col items-center justify-center border-2 border-[#FFB433]/15/50 dark:border-[#8B5E00]">
                                ...
                                <span className="text-xs text-[#FFB433] font-normal uppercase tracking-widest mb-1">통과 기준</span>
                                <span className="text-body-lg-res font-normal text-[#FFB433] dark:text-[#FFB433]">{PASS_THRESHOLD}점 이상</span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-3 text-left w-full">
                            <div className="flex items-center gap-4 bg-[#FF9B73]/10/50 dark:bg-[#FF9B73]/20/30 rounded-2xl px-5 py-4 border-2 border-[#FF9B73]/20/50 dark:border-[#FF9B73]/30">
                                ...
                                <p className="text-[#5B677A] dark:text-[#AEB7C5] font-normal text-sm leading-tight">
                                    통과 시 <span className="text-[#FF9B73] dark:text-[#FF9B73] font-normal">학습지 2개 추가 오픈</span>
                                </p>
                            </div>
                        </div>

                        {unlockedHanja.length < 3 && (
                            <p className="text-red-500 font-normal text-sm bg-red-50 dark:bg-red-900/20 px-4 py-2 rounded-xl border border-red-100 dark:border-red-800 w-full">
                                학습지를 3개 이상 완료해야 합니다.
                            </p>
                        )}
                    </div>
                    ...
                    <button
                        ...
                        className="w-full max-w-md py-5 rounded-[2rem] font-normal text-h3 text-white disabled:bg-slate-300 active:scale-95 transition-all shadow-xl flex items-center justify-center gap-2"
